#!/usr/bin/env python3
"""Render Reel 0002 with captioned image-led motion when video generation is unavailable."""
...
REEL = PROJECT / "reels-production/batches/Batch_001/Reel_0002"
SOURCE_IMAGES = [
...
AUDIO = REEL / "voice" / "Reel_0002_hi_final_60s.wav"
OUTPUT = REEL / "video" / "Reel_0002_final_1080x1920.mp4"
...
def main() -> int:
    ...
    for index, source in enumerate(SOURCE_IMAGES, start=1):
        ...
        zoom = "min(zoom+0.00005,1.075)" if index == 1 else "max(zoom-0.000035,1.0)"
        vf = (
